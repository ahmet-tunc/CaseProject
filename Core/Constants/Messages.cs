...
namespace Core.Constants
{
    public static class Messages
    {
        ...
        public static string AddedList(string fieldName) => $"{fieldName} list added successfully";
        ...
        public static string SetActive(string fieldName) => $"{fieldName} has been deactivated";
